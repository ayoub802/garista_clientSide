...
{/* <NavBar/> */}
  ...
  <article className="p-0.5 mb-4 bg-cover bg-transparent overflow-hidden relative" style={{ borderRadius: '2.7rem' }}>
    ...
    <Image
  className="absolute inset-0 w-full h-full object-cover rounded-4.5rem bg-cover bg-center z-0"
  src="/photo/offer.jpg"
  alt="Offer"
  width={100}
  height={100}
...
/>
    ...
    <div className="font-normal uppercase text-center text-white">
    <span className="text-md font-bold bg-transparent">Enjoy the great</span>
        ...
        <div className="grid sm:grid-cols-2 grid-cols-2 gap-[1rem]">
          {burgersData.map((burger) => (
            <div key={burger.id} className="w-full sm:w-full md:w-auto bg-gray ">
              <Link href={burger.link} passHref className="block text-white no-underline rounded-md text-sm font-medium">
